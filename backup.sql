...
CREATE TABLE `tbl_avaliacao` (
  ...
  `idFilialServico` int(11) NOT NULL,
  PRIMARY KEY (`idAvaliacao`),
  KEY `fk_avaliacao_usuario_idx` (`idUsuario`),
  KEY `fk_avaliacao_filial_idx` (`idFilialServico`),
  CONSTRAINT `fk_avaliacao_filial` FOREIGN KEY (`idFilialServico`) REFERENCES `tbl_filial_servico` (`idFilialServico`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_avaliacao_usuario` FOREIGN KEY (`idUsuario`) REFERENCES `tbl_usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tbl_categoria_forum`
--

DROP TABLE IF EXISTS `tbl_categoria_forum`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `tbl_categoria_forum`
--
...
CREATE TABLE `tbl_cidade` (
  ...
  KEY `fk_estado_cidade_idx` (`idEstado`),
  CONSTRAINT `fk_estado_cidade` FOREIGN KEY (`idEstado`) REFERENCES `tbl_estado` (`idEstado`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
--
-- Table structure for table `tbl_combustivel_veiculo`
--

DROP TABLE IF EXISTS `tbl_combustivel_veiculo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_combustivel_veiculo` (
  `idCombustivelVeiculo` int(11) NOT NULL AUTO_INCREMENT,
  `idVeiculo` int(11) NOT NULL,
  `idCombustivel` int(11) NOT NULL,
  PRIMARY KEY (`idCombustivelVeiculo`),
  KEY `fk_combustivel_idx` (`idCombustivel`),
  KEY `fk_veiculo_idx` (`idVeiculo`),
  CONSTRAINT `fk_combustivel_veiculo` FOREIGN KEY (`idCombustivel`) REFERENCES `tbl_combustivel` (`idCombustivel`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_veiculo_combustivel` FOREIGN KEY (`idVeiculo`) REFERENCES `tbl_veiculo` (`idVeiculo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_combustivel_veiculo`
--

LOCK TABLES `tbl_combustivel_veiculo` WRITE;
/*!40000 ALTER TABLE `tbl_combustivel_veiculo` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_combustivel_veiculo` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tbl_endereco_funcionario` (
  ...
  KEY `fk_tipo_endereco_funcionario_idx` (`idTipoEndereco`),
  KEY `fk_cidade_endereco_funcionario_idx` (`idCidade`),
  CONSTRAINT `fk_cidade_endereco_funcionario` FOREIGN KEY (`idCidade`) REFERENCES `tbl_cidade` (`idCidade`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tipo_endereco_funcionario` FOREIGN KEY (`idTipoEndereco`) REFERENCES `tbl_tipo_endereco` (`idTipoEndereco`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `tbl_endereco_funcionario` VALUES (1,'Rua Teste de Oliveira','156',NULL,'Jd Teste','06715-123',1,4586);
/*!40000 ALTER TABLE `tbl_endereco_funcionario` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tbl_endereco_prestadora`
--

DROP TABLE IF EXISTS `tbl_endereco_prestadora`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_endereco_prestadora` (
  `idEnderecoPrestadora` int(11) NOT NULL AUTO_INCREMENT,
  `logradouro` varchar(255) NOT NULL,
...
--
-- Dumping data for table `tbl_endereco_prestadora`
--
...
INSERT INTO `tbl_fale_conosco` VALUES (5,'jhonatha','jhonw@hotmail.com','jhow jhow');
...
CREATE TABLE `tbl_fornecedor` (
  ...
  `nome` varchar(255) NOT NULL,
  `servicoPrestado` varchar(100) NOT NULL,
...
CREATE TABLE `tbl_foto_veiculo` (
  `idFotoVeiculo` int(11) NOT NULL AUTO_INCREMENT,
  `foto` text NOT NULL,
  `idVeiculo` int(11) NOT NULL,
...
CREATE TABLE `tbl_funcionario` (
  ...
  KEY `fk_endereco_funcionario_idx` (`idEnderecoFuncionario`),
  KEY `fk_nivel_funcionario_idx` (`idNivelAcesso`),
  CONSTRAINT `fk_endereco_funcionario` FOREIGN KEY (`idEnderecoFuncionario`) REFERENCES `tbl_endereco_funcionario` (`idEnderecoFuncionario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `tbl_funcionario` VALUES (1,'Teste','123','teste','123.123.123-12','1500','1981-09-10','m','Tester','Testar','2010-05-02',1,1,'123.213.222-02','11 4611-5664',1);
...
CREATE TABLE `tbl_historico` (
  ...
  KEY `fk_historico_servico_idx` (`idServico`),
  CONSTRAINT `fk_historico_servico` FOREIGN KEY (`idServico`) REFERENCES `tbl_servico` (`idServico`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tbl_historico_veiculo`
--

DROP TABLE IF EXISTS `tbl_historico_veiculo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_historico_veiculo` (
  `idHistoricoVeiculo` int(11) NOT NULL AUTO_INCREMENT,
  `idVeiculo` int(11) NOT NULL,
  `idHistorico` int(11) NOT NULL,
  PRIMARY KEY (`idHistoricoVeiculo`),
  KEY `fk_veiculo_historico_idx` (`idVeiculo`),
  KEY `fk_historico_idx` (`idHistorico`),
  CONSTRAINT `fk_historico` FOREIGN KEY (`idHistorico`) REFERENCES `tbl_historico` (`idHistorico`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_veiculo_historico` FOREIGN KEY (`idVeiculo`) REFERENCES `tbl_veiculo` (`idVeiculo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_historico_veiculo`
--

LOCK TABLES `tbl_historico_veiculo` WRITE;
/*!40000 ALTER TABLE `tbl_historico_veiculo` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_historico_veiculo` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `tbl_marca_produto`
--

DROP TABLE IF EXISTS `tbl_marca_produto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_marca_produto` (
...
--
-- Dumping data for table `tbl_marca_produto`
--

LOCK TABLES `tbl_marca_produto` WRITE;
/*!40000 ALTER TABLE `tbl_marca_produto` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_marca_produto` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tbl_modulo` VALUES (1,'Teste');
...
INSERT INTO `tbl_nivel_acesso` VALUES (1,'Teste');
/*!40000 ALTER TABLE `tbl_nivel_acesso` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tbl_nivel_modulo`
--

DROP TABLE IF EXISTS `tbl_nivel_modulo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_nivel_modulo` (
  `idNivelModulo` int(11) NOT NULL AUTO_INCREMENT,
  `idNivel` int(11) NOT NULL,
  `idModulo` int(11) NOT NULL,
  PRIMARY KEY (`idNivelModulo`),
  KEY `fk_nivel_idx` (`idNivel`),
  KEY `fk_modulo_idx` (`idModulo`),
  CONSTRAINT `fk_modulo` FOREIGN KEY (`idModulo`) REFERENCES `tbl_modulo` (`idModulo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_nivel` FOREIGN KEY (`idNivel`) REFERENCES `tbl_nivel_acesso` (`idNivelAcesso`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_nivel_modulo`
--

LOCK TABLES `tbl_nivel_modulo` WRITE;
/*!40000 ALTER TABLE `tbl_nivel_modulo` DISABLE KEYS */;
INSERT INTO `tbl_nivel_modulo` VALUES (2,1,1);
/*!40000 ALTER TABLE `tbl_nivel_modulo` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `tbl_notificacao_usuario`
--

DROP TABLE IF EXISTS `tbl_notificacao_usuario`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_notificacao_usuario` (
  `idNotificacaoUsuario` int(11) NOT NULL AUTO_INCREMENT,
  `idUsuario` int(11) NOT NULL,
  `idNotificacao` int(11) NOT NULL,
  PRIMARY KEY (`idNotificacaoUsuario`),
  KEY `fk_notificacao_idx` (`idNotificacao`),
  KEY `fk_notificacao_usuario_idx` (`idUsuario`),
  CONSTRAINT `fk_notificacao` FOREIGN KEY (`idNotificacao`) REFERENCES `tbl_notificacao` (`idNotificacao`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_notificacao_usuario` FOREIGN KEY (`idUsuario`) REFERENCES `tbl_usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_notificacao_usuario`
--

LOCK TABLES `tbl_notificacao_usuario` WRITE;
/*!40000 ALTER TABLE `tbl_notificacao_usuario` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_notificacao_usuario` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tbl_plano` VALUES (1,'Teste',200.00,'rsyteyet','imagenPlano/plano.jpg'),(2,'Teste',200.00,'kk','imagenPlano/plano.jpg'),(3,'Teste',200.00,'yrrtyrtyrty','imagenPlano/LOGO5.png'),(4,'antonio willian',200.98,'e54t4345345','imagenPlano/Captura de Tela (1).png'),(5,'luana',56.00,'plano editado','imagenPlano/517334870.jpg');
...
CREATE TABLE `tbl_prestadora` (
  ...
  KEY `fk_endereco_prestadora_idx` (`idEnderecoPrestadora`),
  CONSTRAINT `fk_endereco_prestadora` FOREIGN KEY (`idEnderecoPrestadora`) REFERENCES `tbl_endereco_prestadora` (`idEnderecoPrestadora`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tbl_rapberry`
--

DROP TABLE IF EXISTS `tbl_rapberry`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_rapberry` (
  `idRaspberry` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `tbl_rapberry`
--

LOCK TABLES `tbl_rapberry` WRITE;
/*!40000 ALTER TABLE `tbl_rapberry` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rapberry` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tbl_recebimento`
--

DROP TABLE IF EXISTS `tbl_recebimento`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_recebimento` (
...
--
-- Dumping data for table `tbl_recebimento`
--

LOCK TABLES `tbl_recebimento` WRITE;
/*!40000 ALTER TABLE `tbl_recebimento` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_recebimento` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tbl_resposta` (
  `idResporsta` int(11) NOT NULL AUTO_INCREMENT,
  `resposta` varchar(45) NOT NULL,
  `idPergunta` int(11) NOT NULL,
  PRIMARY KEY (`idResporsta`),
  KEY `fk_pergunta_resposta_idx` (`idPergunta`),
  CONSTRAINT `fk_pergunta_resposta` FOREIGN KEY (`idPergunta`) REFERENCES `tbl_pergunta` (`idPergunta`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tbl_seguidor`
--

DROP TABLE IF EXISTS `tbl_seguidor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_seguidor` (
  `idSeguidor` int(11) NOT NULL AUTO_INCREMENT,
  `idUsuarioSeguido` int(11) NOT NULL,
  `idUsuarioSeguindo` int(11) NOT NULL,
  PRIMARY KEY (`idSeguidor`),
  KEY `fk_usuario_seguidor_idx` (`idUsuarioSeguindo`),
  KEY `fk_usuario_seguido_idx` (`idUsuarioSeguido`),
  CONSTRAINT `fk_usuario_seguido` FOREIGN KEY (`idUsuarioSeguido`) REFERENCES `tbl_usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_usuario_seguidor` FOREIGN KEY (`idUsuarioSeguindo`) REFERENCES `tbl_usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_seguidor`
--

LOCK TABLES `tbl_seguidor` WRITE;
/*!40000 ALTER TABLE `tbl_seguidor` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_seguidor` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tbl_servico` VALUES (4,'teste','sdtrteryery','imagenPlano/Captura de Tela (1).png'),(5,'wrtwsrtser','erteryetyrty','imagenPlano/Captura de Tela (1).png');
...
CREATE TABLE `tbl_slider_home` (
  `idSliderHome` int(11) NOT NULL AUTO_INCREMENT,
  `foto` varchar(255) NOT NULL,
  PRIMARY KEY (`idSliderHome`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tbl_status_compra`
--

DROP TABLE IF EXISTS `tbl_status_compra`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `tbl_status_compra`
--
...
CREATE TABLE `tbl_status_pedido` (
  ...
  `idStatusCompra` int(11) NOT NULL,
  PRIMARY KEY (`idStatusPedido`),
  KEY `fk_pedido_status_idx` (`idPedido`),
  KEY `fk_status_idx` (`idStatusCompra`),
  CONSTRAINT `fk_pedido_status` FOREIGN KEY (`idPedido`) REFERENCES `tbl_pedido` (`idPedido`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_status` FOREIGN KEY (`idStatusCompra`) REFERENCES `tbl_status_compra` (`idStatus`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_tema` (
  ...
  `cor1` varchar(6) NOT NULL,
  `cor2` varchar(6) NOT NULL,
  `cor3` varchar(6) NOT NULL,
  PRIMARY KEY (`idTema`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_tipo_endereco` VALUES (1,'Residencial'),(2,'Comercial'),(3,'Postal');
...
CREATE TABLE `tbl_usuario` (
  ...
  KEY `fk_usuario_endereco_idx` (`idEnderecoUsuario`),
  CONSTRAINT `fk_usuario_endereco` FOREIGN KEY (`idEnderecoUsuario`) REFERENCES `tbl_endereco_usuario` (`idEnderecoUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_veiculo` (
  ...
  KEY `fk_veiculo_usuario_idx` (`idUsuario`),
...
--
/*!50003 DROP PROCEDURE IF EXISTS `loginFuncionario` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `loginFuncionario`(in _usuario varchar(100), in _senha varchar(100), out _idFuncionario tinyint(1))
BEGIN
...
-- Dump completed on 2018-03-29 11:27:49
