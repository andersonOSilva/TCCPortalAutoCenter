     ...
     <div class="principal">
         ...
         <div class="menu_home">
             <div style="width:100%;" >
                <div class="logo">
                 <div class="enfeite">
<!--											<img src="imagens/logos/logo3.png" alt="">-->
                 </div>
                 <a href="#slide"><img src="imagens/logos/logo9.png" alt="teste de logo" id="imgLogo"></a>
               </div>
         ...
         <div class="container_slider">
             <div id="slider">
<!--
                               <div style="background-color:rgba(255,255,255,0.1);max-width: 100%;
 height: 100vh;
...
<!--							</div>-->
         ...
         <div class="container_menu_sevicos">
             <div id="Servicos">
               <a href="servico.php"><div class="titulo_principal_servicos">
                 <h2>Serviços</h2>
               </div></a>
               <?php
                 //Inclui as classes
                 ...
                 <div class="servicos_itens">
                     <div class="titulo_servico">
                         ...
                         <div class="descricao_titulo_servico">
                             <p><a href="servico01.php?idservico=<?php echo $list[$cont]->idServico ?>"><?php echo $list[$cont]->nome; ?></a></p>
                         </div>
                     </div>
         ...
         <div class="container_menu_Prestadoras" >
             <div style="background-color:rgba(0,0,0,0.7);" >
                           <div id="Prestadoras"  >
               <a href="prestadoras.php"><div class="titulo_principal_servicos">
                 <h1>Prestadoras</h1>
               </div></a>
               <div id="carrossel_prestadora"  >
                   <div class="passar_carrosel">
                       <a href="#" class="prev"> <img src="imagens/voltar.png" alt=""> </a>
                   </div>
                   <div id="carrossel_prestadora_principal">
                       ...
                       <div class="passar_carrosel ">
                           <a href="#" class="next"><img src="imagens/next.png" alt=""> </a>
                       </div>
         ...
         <div class="container_menu_Produtos">
             <div id="Produtos">
                 <a href="produtos.php"><div class="titulo_principal_servicos">
                   <h2>Produtos</h2>
                 </div></a>
                 <div id="carrossel_produtos">
                     <div class="passar_carrosel">
                         <a href="#" class="prev1"> <img src="imagens/voltar.png" alt=""> </a>
                     </div>
                     <div id="carrossel_produtos_principal">
                         <ul>
                           ...
                           $listProdutos=$controller_produtos::BuscarTodos();
                           $cont = 0;
                             ...
                             <a href="#">
                               <div class="segura_produto">
                                 <div class="foto_produto">
                                     <img src="<?php echo (utf8_decode('cms/'.$listProdutos[$cont]->imagem))  ?>" alt="mecanica">
                                 </div>

                                 <div class="descricao_produto" >
                                     <p>
                                       <?php echo (utf8_decode($listProdutos[$cont]->descricao))  ?>
                                     </p>
                                 </div>
                                 <div class="valor_produto">
                                     <p><span class="sifrao">R$</span> <?php echo (utf8_decode($listProdutos[$cont]->preco))  ?></p>
                                 </div>
                     ...
                     <div class="passar_carrosel ">
                         <a href="#" class="next1"><img src="imagens/next.png" alt=""> </a>
                     </div>
                 </div>
                 <div class="ver_mais_coisas">
                   <a href="#">Ver mais</a>
         ...
         <div class="container_menu_CarBook">
           <div style="background-color:rgba(0,0,0,0.7);" >
             <div id="CarBook">
               <a href="carBook.php"><div class="titulo_principal_servicos">
                 <h1>CarBook</h1>
               </div></a>
...
<!--                                    style="background-color:rgba(255,255,255,0.5);color:black;border-radius:20px;"-->
         ...
         <!-- Forum -->
         <div class="container_menu_forumHome">
           <div style="background-color:rgba(0,0,0,0.7);" >
                       <div id="Forum">
               <a href="homeforum.php"><div class="titulo_principal_servicos">
                 <h1>Forum</h1>
               </div></a>

               <?php
                 require_once 'cms/controllers/forumHome_controller.php';
                 require_once 'cms/models/forumHome_class.php';

                 $controller_forumHome = new controllerForumHome();

                 $listForumHome=$controller_forumHome::Buscar();
                 $cont = 0;

                 while ($cont < count($listForumHome)) {

                ?>

               <div class="foto_forum">
                 <img src="cms/<?php echo $listForumHome[$cont]->foto; ?>" alt="">
               </div>

               <div class="descricao_forumhome" >
                   <p><?php echo $listForumHome[$cont]->descricao; ?></p>
               </div>
